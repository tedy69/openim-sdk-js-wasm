...
const InternalConstraint = [
  ...
  ['sender_facebackground_color', 'senderFaceBackgroundColor'],
  ...
  ['ex', 'ex'],
  ['local_ex', 'localEx'],
  ['envelope_claimed_info', 'envelopeClaimedInfo'],
  ['transfer_claimed_info', 'transferClaimedInfo'],
  ['face_url', 'faceURL'],
  ['face_background_color', 'faceBackgroundColor'],
  ...
  ['from_face_background_color', 'fromFaceBackgroundColor'],
  ...
  ['to_face_background_color', 'toFaceBackgroundColor'],
  ['to_gender', 'toGender'],
  ['req_msg', 'reqMsg'],
